...
export default function HomePage(props) {
  ...
  return (
    <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 md:gap-5 justify-center pb-20'>
      <h1 className='font-semi-bold text-5xl sm:text-6xl md:text-7xl'>Free<span className='text-blue-400 bold '>Scribe</span></h1>
        ...
        <p className='text-base'>Or <label className='text-blue cursor-pointer hover:text-blue-400 duration-200'> 
