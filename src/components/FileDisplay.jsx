...
export default function FileDisplay(props) {
  ...
  return (
    ...
    <h1 className='font-semi-bold text-4xl sm:text-5xl md:text-6xl'>Your<span className='text-blue-400 bold '>File</span></h1>
    <div className='flex mx-auto flex-col text-left mb-4 my-4'>
